		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rentals",
									"targetURL": "#rentalsrentals-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rentalsrentals-display": {
								"semanticObject": "rentalsrentals",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rentals.rentals",
									"url": sap.ui.require.toUrl("rentals/rentals")
								}
							}
						}
					}
