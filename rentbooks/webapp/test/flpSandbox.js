		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "library",
									"targetURL": "#booksrentbooks-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"booksrentbooks-display": {
								"semanticObject": "booksrentbooks",
								"action": "display",
								"description": "A Fiori application for checkouts",
								"title": "library",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=books.rentbooks",
									"url": sap.ui.require.toUrl("books/rentbooks")
								}
							}
						}
					}
