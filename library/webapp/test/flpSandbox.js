		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Books",
									"targetURL": "#booklistlibrary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"booklistlibrary-display": {
								"semanticObject": "booklistlibrary",
								"action": "display",
								"description": "A Fiori application for Books.",
								"title": "Books",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=booklist.library",
									"url": sap.ui.require.toUrl("booklist/library")
								}
							}
						}
					}
